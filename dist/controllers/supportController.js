...
exports.autoCloseTicket = exports.markMessagesAsSeen = exports.getUserTickets = exports.getTicketStats = exports.submitFeedback = exports.closeUserTicket = exports.updateTicketStatus = exports.sendMessage = exports.getTicketWithMessages = exports.getTickets = exports.createTicket = exports.setSocketInstance = void 0;
...
const autoCloseTicket = async (req, res) => {
    try {
        const { id } = req.params;
        ...
        const updatedTicket = await Ticket_1.default.findByIdAndUpdate(id, {
            status: "closed",
            updatedAt: new Date(),
        }, { new: true })
            .populate("userId", "username email")
            .populate("assignedAdmin", "username");
        const autoCloseMessage = new Message_1.default({
            ticketId: id,
            sender: "admin",
        ...
        await autoReplyService_1.AutoReplyService.sendFeedbackRequest(id);
        console.log(`🕒 Ticket ${id} auto-closed due to user inactivity (${inactiveMinutes} minutes)`);
        res.json({
            success: true,
            data: {
                ticket: updatedTicket,
...
exports.autoCloseTicket = autoCloseTicket;
